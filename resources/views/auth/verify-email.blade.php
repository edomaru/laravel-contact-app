            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        <p class="mb-0"><strong>Thanks for signing up!</strong> Before getting started, please verify your email address by clicking on the link we just emailed to you.</p>
