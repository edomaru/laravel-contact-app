          ...
          <div class="col-md-3">
              <div class="card">
                  ...
                  <div class="list-group list-group-flush">
                      <a href="{{ route('user-profile-information.edit') }}" class="list-group-item list-group-item-action active">Profile</span></a>
                  ...
                  <div class="row">
                    <div class="col-md-8">
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" name="name" value="{{ old('name', $user->name) }}" id="name" class="form-control @error('first_name') is-invalid @enderror">
                          @error('name')
